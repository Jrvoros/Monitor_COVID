...
begin
  Try
    ...
    begin
      ...
      if FilterText <> '' then
      begin
        // Aplica o filtro para buscar pelo nome do país (case-insensitive)
  ...
  Except
    ...
    begin
      ...
      ShowMessage('Não foi possível acessar os dados no momento. Verifique sua conexão com a internet ou tente novamente mais tarde.');
